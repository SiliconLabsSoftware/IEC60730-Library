 ...
 ******************************************************************************/
 ...
 #define IEC60730_UT_USE_SL_MAIN
 ...
 #if defined(IEC60730_UT_USE_SL_MAIN)
 ...
 #else // IEC60730_UT_USE_SL_MAIN
 #include "sl_system_init.h"
 #define sl_main_init sl_system_init
 #if defined(SL_CATALOG_KERNEL_PRESENT)
 #include "sl_system_kernel.h"
 #define sl_main_kernel_start sl_system_kernel_start
 #else // SL_CATALOG_KERNEL_PRESENT
 #include "sl_system_process_action.h"
 #define sl_main_process_action sl_system_process_action
 #endif // SL_CATALOG_KERNEL_PRESENT
 #endif // IEC60730_UT_USE_SL_MAIN
