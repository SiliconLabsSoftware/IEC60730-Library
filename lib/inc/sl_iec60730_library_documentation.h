 ...
 *
 * Files under lib/toolchain/template/GCC and lib/toolchain/template/IAR are distributed under the terms of the Zlib license. It is based on the original version (refer link: linkerfile.ld.jinja and linkerfile.icf.jinja) and has been modified to fit this repository.
 *
